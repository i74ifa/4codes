    ...
    <div class="w-full justify-center items-center bg-white shadow hover:shadow-md duration-500 flex flex-col border">
        ...
        <div class="w-full pt-5 px-2 py-3 justify-start flex flex-col">
            <div class="overflow-hidden">
                <h4 class="py-4 text-sm">{{ $cardTitle }}</h4>
            </div>
            <hr>
            ...
            <div class="w-full flex md:gap-x-5 gap-x-3">
                <x-a rounded color="green" class="h-auto flex-1 text-center flex justify-center" href="{{ $cardSending }}" target="_blank">
                ...
                <x-a rounded color="gray" class="h-auto flex-1 text-center" href="{{ $cardDetail }}">
                    {{ __('Details') }}</x-a>
            </div>
        </div>
    </div>
